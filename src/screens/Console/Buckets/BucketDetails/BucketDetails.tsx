...
const BucketDetails = ({
  ...
  let topLevelRoute = `/reporter/minio/buckets/${bucketName}`;
  ...
  const closeDeleteModalAndRefresh = (refresh: boolean) => {
    setDeleteOpen(false);
    if (refresh) {
      history.push("/reporter/minio/buckets");
    }
  };

  const openBucketBrowser = () => {
    history.push(`/reporter/minio/buckets/${bucketName}/browse`);
  };
  ...
  return (
    <Fragment>
      ...
      <PageHeader
        label={
          <Fragment>
            <Link to={"/reporter/minio/buckets"} className={classes.breadcrumLink}>
              Buckets
            </Link>
          </Fragment>
        }
      ...
      />
      <BackLink to={"/reporter/minio/buckets"} label={"Back to Buckets"} />
            ...
            <div className={classes.contentSpacer}>
              <Router history={history}>
                <Switch>
                  <Route
                    exact
                    path="/reporter/minio/buckets/:bucketName/admin/summary"
                    component={BucketSummaryPanel}
                  />
                  <Route
                    exact
                    path="/reporter/minio/buckets/:bucketName/admin/events"
                    component={BucketEventsPanel}
                  />
                  {distributedSetup && (
                    <Route
                      exact
                      path="/reporter/minio/buckets/:bucketName/admin/replication"
                  ...
                  {distributedSetup && (
                    <Route
                      exact
                      path="/reporter/minio/buckets/:bucketName/admin/lifecycle"
                  ...
                  <Route
                    exact
                    path="/reporter/minio/buckets/:bucketName/admin/access"
                    component={AccessDetailsPanel}
                  />
                  <Route
                    exact
                    path="/reporter/minio/buckets/:bucketName/admin/prefix"
                    component={AccessRulePanel}
                  />
                  <Route
                    path="/reporter/minio/buckets/:bucketName"
                    component={() => (
                      <Redirect to={`/reporter/minio/buckets/${bucketName}/admin/summary`} />
                    )}
                  />
                </Switch>
              </Router>
