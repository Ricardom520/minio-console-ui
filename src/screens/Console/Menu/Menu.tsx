...
const Menu = ({
  ...
  const logout = () => {
    const deleteSession = () => {
      ...
      history.push("/reporter/minio/login");
    };
    api
      .invoke("POST", `/reporter/minioServer/api/v1/logout`)
      .then(() => {
        deleteSession();
      })
